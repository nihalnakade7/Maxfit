...
import Start_DateTime_c__c from '@salesforce/schema/Event__c.Start_DateTime_c__c';
...
export default class AddEvent extends NavigationMixin(LightningElement) {
    ...
    */
    ...
    handleClick() {
        ...
        fields[Start_DateTime_c__c.fieldApiName] = this.eventRecord.Start_DateTime_c__c;
